...
import {BenchmarkOpts, BenchmarkResult, Convergence, ConvergenceCheckFn, ConvergenceEnum} from "../types.ts";
import {OutlierSensitivityEnum, calcSum, filterOutliers} from "../utils/math.ts";
