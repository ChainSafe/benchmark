...
// import {BenchmarkRunOptsWithFn, runBenchFn} from "../benchmark/runBenchFn.js";
...
//   // console.trace(itFn, opts.id);

//   itFn(opts.id, async () => {
//     // console.log("%%%%%%%%%%%%%%%%%%", opts.id, getCurrentSuite());
...
//     // console.log({opts, persistRunsNs});
//     // const {result, runsNs} = await runBenchFn(opts, persistRunsNs);
//     await runBenchFn(opts, false);
